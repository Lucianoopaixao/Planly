...
export default function Achievements() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: `linear-gradient(135deg, ${c.forestD}, ${c.forest})`,
          color: c.creamL,
          borderRadius: 24,
          padding: 40,
          position: "relative",
        ...
        >
          <div>
            ...
            >
              ...
              <span style={{ fontSize: 24, color: "rgba(245,239,227,0.4)" }}>
                / {list.length}
              </span>
            </div>
            <div
            ...
            >
              ...
              {stats &&
                ` · ${stats.total_completed} tarefas concluídas no total`}
            </div>
          </div>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <span
                  style={{
                    ...
                    whiteSpace: "nowrap",
                    lineHeight: 1,
                    background: `${RARITY[a.rarity] || c.muted}20`,
                    color: RARITY[a.rarity] || c.muted,
                  }}
                >
                  {a.rarity}
                </span>
              ...
              <div
                style={{
                  ...
                  fontSize: "1.2rem",
                  fontWeight: 500,
                  color: a.unlocked ? c.ink : c.muted,
                }}
              >
                {a.name}
              </div>
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${pct}%`,
                      background: a.unlocked ? c.gold : c.border,
                      borderRadius: 999,
                    }}
                  />
                </div>
